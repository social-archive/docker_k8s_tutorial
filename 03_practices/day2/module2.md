...
```powershell
kubectl apply -f k8s/postgres-pvc.yml -n todo-app
...
```powershell
kubectl apply -f k8s/postgres-deployment.yml -n todo-app
...
```powershell
kubectl apply -f k8s/postgres-service.yml -n todo-app
